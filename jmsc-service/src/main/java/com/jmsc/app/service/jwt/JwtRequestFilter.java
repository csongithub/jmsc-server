...
//	    }
		...
		if (requestTokenHeader != null && requestTokenHeader.startsWith(JWT_TOKEN_PREFIX)) {
			...
			try {
				logonId = jwtTokenUtil.getUsernameFromToken(jwtToken);
		...
		if (logonId != null && SecurityContextHolder.getContext().getAuthentication() == null) {
			UserDetails userDetails = null;
			try
			{
				userDetails = jwtClientDetailsService.loadUserByUsername(logonId);
