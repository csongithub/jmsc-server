...
--INDEXES
CREATE INDEX INDEX_CAPITAL_ACCOUNT_ENTRY_1 ON jmsc.CAPITAL_ACCOUNT_ENTRY(ID, CLIENT_ID, DATE);
CREATE INDEX INDEX_CAPITAL_ACCOUNT_ENTRY_2 ON jmsc.CAPITAL_ACCOUNT_ENTRY(CLIENT_ID, ACCOUNT_ID, DATE);
